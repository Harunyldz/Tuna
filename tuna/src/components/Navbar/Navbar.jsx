    ...
    <div className="navbar-container">
      <div className="navbar">
        ...
        <ul className="navbar-links">
          ...
          <li className="navbar-link">Kurumsal</li>
          <li className="navbar-link">Eğitimler</li>
          <li className="navbar-link">İSG Hizmetleri</li>
          <li className="navbar-link">Sağlık Hizmetleri</li>
