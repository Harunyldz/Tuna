  ...
  return (
    <div className="info">
      <div className="hesapla">
        ...
        <p>
          Tehlike sınıfını ve çalışan sayısını girerek iş yeriniz için alınması
          gereken hizmetleri ve gerekli acil durum ekip sayılarını
          öğrenebilirsiniz.
        </p>
      </div>
      <div className="tablo">
        ...
        <div className="tablo-items">
          ...
          <div className="tablo-item">
            ...
            <span>{Math.ceil(employeeCount / riskData.korumaEkibi)} Kişi</span>
          </div>
          <div className="tablo-item">
